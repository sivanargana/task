...
<nav aria-label="breadcrumb" class="tw-flex-none">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Test Series</li>
...
<div
  ...
  <div class="tw-flex tw-items-center tw-gap-[10px] tw-justify-center">
  <div
            class="tw-border-2 tw-border-dashed tw-border-gray-300 tw-rounded-[5px] tw-bg-gray-100 tw-px-[10px] tw-h-[38px] tw-flex tw-items-center tw-gap-[10px]">
