...
<div
    ...
    <div class="tw-bg-white tw-rounded-[10px] tw-p-[10px] tw-shadow tw-flex tw-flex-col tw-gap-[10px] tw-cursor-pointer tw-transition-all tw-duration-300 tw-ease-out hover:tw-scale-[1.05]">
        <img src="<?= $test['image'] ?>"
        ...
        <div class="tw-flex tw-flex-col">
            ...
            <div class="tw-flex tw-justify-center tw-my-[10px]">
                <div class="tw-flex tw-flex-col tw-px-[20px] tw-border-0 tw-border-solid tw-border-r tw-border-gray-300">
                    <div class="tw-font-bold tw-text-[20px] tw-text-center"><?= $test['no_of_questions'] ?></div>
                    <div class="tw-text-[14px] tw-text-gray-400 tw-text-center">Questions</div>

                </div>
                <div class="tw-flex tw-flex-col tw-px-[20px]">
                    <div class="tw-font-bold tw-text-[20px] tw-text-center"><?= $test['duration'] ?> Mins</div>
