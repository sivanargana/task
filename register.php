<?php include("includes/header.php"); ?>
    ...
    <div class="tw-bg-[#F7F7FA] tw-min-h-screen tw-grid tw-grid-cols-12">
        ...
        <div class="tw-bg-orange-100 tw-col-span-12 xl:tw-col-span-7 tw-flex tw-flex-col tw-items-center tw-justify-center tw-min-w-0 tw-p-[20px] md:tw-p-[40px]">
            <img src="assets/images/register.svg"  class="tw-w-[600px] tw-max-w-full">
        </div>
        <div class="tw-bg-white tw-col-span-12 xl:tw-col-span-5 tw-min-w-0 tw-flex tw-flex-col tw-justify-center tw-p-[20px] md:tw-p-[40px]">

            <div class="md:tw-w-[450px] tw-max-w-full tw-mx-auto">
                <img src="assets/images/logo.svg" class="tw-h-[50px] tw-max-w-full tw-mb-[40px] md:tw-mb-[40px]" />
